          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left">
                ...
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase tracking-wide text-right">
                  Daily Cap
                </th>
              ...
              {clients.map((c) => (
                <tr key={c.client_id} className="group">
                  ...
                  <td className="py-3 text-right">
                    <Link
                      href={`/clients`}
                      className="opacity-0 group-hover:opacity-100 transition-opacity text-gray-500 hover:text-yellow-400"
                    >
